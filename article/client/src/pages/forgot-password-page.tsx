...
export function ForgotPasswordPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-4 sm:py-6">
      ...
      <Card className="relative w-full max-w-3xl overflow-hidden p-6 sm:p-7">
        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 font-display text-3xl text-ink sm:text-[40px]">Reset access securely</h1>
          </div>
